...
const movies = [
  ...
  { src: "https://raw.githubusercontent.com/carlosavilae/Netflix-Clone/master/img/p6.PNG", alt: "Slide 6", name: "Liquid science", description: "Liquid Science is a documentary series that explores the intersection of science, technology, and hip-hop culture. Hosted by rapper and entrepreneur GZA (also known as The Genius), the show delves into various scientific concepts and innovations, drawing parallels between the creative processes in hip-hop and the principles of scientific discovery." },
  { src: "https://github.com/carlosavilae/Netflix-Clone/blob/master/img/p7.PNG?raw=true", alt: "Slide 7", name: "i3 reason why", description: "I, 3 Reasons Why is a thought-provoking and informative series that dives deep into complex topics by presenting three compelling reasons to support a specific viewpoint. Hosted by a diverse panel of experts, each episode explores a different subject, ranging from social issues to scientific advancements, politics, and beyond." },
  ...
  { src: "https://github.com/carlosavilae/Netflix-Clone/blob/master/img/p11.PNG?raw=true", alt: "Slide 11", name: "Marcella", description: "Marcella is a British crime noir television series created by Hans Rosenfeldt. The show first premiered in 2016 and has since gained a dedicated fanbase for its gripping storyline, complex characters, and intense atmosphere." },
