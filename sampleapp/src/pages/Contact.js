...
031 035 0105/6
      ...
      margin="normal"
      required
      value={authUser?.fullName || "N/A"} // Display the fullName or fallback to "N/A"
      InputProps={{
    ...
    />
      ...
      type="email"
      required
      value={authUser?.email || "N/A"} // Display the email or fallback to "N/A"
      InputProps={{
        readOnly: true, // Make the field read-only
      }}
    />
      ...
      sx={{
        ...
        '&:hover': { backgroundColor: "slategrey" } // Optional hover effect
      }}
    >
      Submit
    </Button>
